...
<aside class="app-sidebar">
    <ul class="app-menu">
        ...
        <li class="treeview <?php if($active_menu==301 || $active_menu==302 || $active_menu==303|| $active_menu==3001) {echo "is-expanded"; } ?>"> <a href="#" class="app-menu__item" data-toggle="treeview"><i class="app-menu__icon fa fa-coffee"></i><span class="app-menu__label">SUBSCRIPTION</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item <?php if($active_menu==302) {echo "active"; } ?>" href="<?php echo base_url().'subscription/sub_setting'?>"><i class="app-menu__icon fa fa fa-wrench" aria-hidden="true"></i><?php echo trans("subscription_setting");?></a></li>
